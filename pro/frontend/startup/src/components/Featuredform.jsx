...
<h3 style={{"marginLeft":"100px"}}><strong>Add Featured Story</strong></h3>
<form className="customform"onSubmit={uploads}>
<div style={{"width":"50%"}}>
<label htmlFor="#" className='s-12 l-4'>Add Logo and Employees Images</label>
<input type="file" name="myFiles" multiple onChange={onchanges}/>
</div>
<div style={{"width":"50%"}}>
<label htmlFor="#" className='s-12 l-4'>Story</label>
<input type="text" value={story} placeholder="Story" required onChange={e=>{setstory(e.target.value)}}/>
</div>
<div style={{"width":"50%"}}>
