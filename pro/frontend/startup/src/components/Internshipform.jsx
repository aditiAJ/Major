...
<h3 style={{"marginLeft":"100px"}}><strong>Add Internships</strong></h3>
...
<div style={{"width":"50%"}}>
<label htmlFor="#" className='s-12 l-4'>Job Role</label>
<input type="text" value={story} placeholder="Job Role" required onChange={e=>{setstory(e.target.value)}}/>
</div>
<div style={{"width":"50%"}}>
