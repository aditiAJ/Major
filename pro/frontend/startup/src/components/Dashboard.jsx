...
<div id="content">
  <div className="line">
    <span className="s-12 m-12 l-8 center">
        <h1 style={{"marginLeft":"55px"}}><strong>FEATURED STORY</strong></h1>
        
        <img src={`${baseurl}${story._id}_3.jpg`} alt="" style={{"border":"1px solid","width":"250px","height":"250px","marginLeft":"100px","float":"left"}}/>
    ...
    <h2>TEAMMATES</h2>
    <img src={`${baseurl}${story._id}_0.jpg`} alt="" style={{"border":"3px solid","width":"200px","height":"150px","marginLeft":"180px","float":"left"}}/>
        <img src={`${baseurl}${story._id}_1.jpg`} alt="" style={{"padding":"5px","border":"3px solid","width":"200px","height":"150px","marginLeft":"380px","float":"left"}}/>
