...
<input type="text" name="myFiles" value={name} placeholder="Your Name" onChange={e=>{setname(e.target.value)}}/>
</div>

<div style={{"width":"50%"}}>
<label htmlFor="#" className='s-12 l-4'>Email</label>
<input type="text" name="myFiles" value={email} placeholder="Your Email" onChange={e=>{setemail(e.target.value)}}/>
</div>
<div style={{"width":"50%"}}>
<label htmlFor="#" className='s-12 l-4'>Feedback</label>
<input type="text" value={story} placeholder="Please enter your feedback" required onChange={e=>{setstory(e.target.value)}}/>
</div>
<div style={{"width":"50%"}}>
